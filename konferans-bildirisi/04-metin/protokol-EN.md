# Section 4 — Production Protocol (English draft)

> Kaynak: yazarın verdiği Türkçe protokol metni + tezdeki formülasyon oranları.
> Çözülmemiş noktalar §4.6'da işaretli.

## 4.1 Preparation of the eggshell fraction

Eggshells were collected from a single local patisserie over a period exceeding
one year. Shells were cleaned of residual membrane and organic matter, then
heat-treated in a laboratory oven at 120 °C for 20 minutes for decontamination
...
reported in the composite literature.

## 4.2 Preparation of the binder phase
...
is consistent with the 70–90 °C range reported for agar-based biomaterial
preparation.

## 4.3 Formation of the composite mixture

Near the end of the cooking stage, with the binder held at 80 °C, the sieved
eggshell fraction was added incrementally under continuous stirring to prevent
agglomeration and sedimentation of the mineral phase. Heating was stopped once
all components were homogeneously distributed and a viscous, pourable mixture
had been obtained.
...
Mass proportions for the formulations characterised in Section 6:

| Test | Formulation | Water (g) | Eggshell (g) | Agar (g) | Glycerol (g) |
|---|---|---|---|---|---|
| Compression | C1 | 325 | 80 | 35 | 5 |
| Compression | C2 | 310 | 90 | 40 | 5 |
| Compression | C3 | 280 | 110 | 45 | 10 |
| Flexure | F1 | 450 | 190 | 70 | 60 |
| Flexure | F2 | 480 | 190 | 70 | 30 |
